"""Command-line interface for Acapella."""
...
from acapella.exceptions import AcapellaError, YouTubeDownloadError
from acapella.logging_config import get_logger, setup_logging
from acapella.models.result import ProcessingOptions
...
def version_callback(value: bool) -> None:
    ...
    if value:
        console.print(f"acapella v{__version__}")
        raise typer.Exit()
